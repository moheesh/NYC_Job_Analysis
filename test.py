...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            dcc.Graph(id='jobs-by-month', style={'width': '100%', 'height': '400px'}),
            dcc.Graph(id='career-level-pie', style={'width': '100%', 'height': '400px'})
        ], style={'width': '50%', 'display': 'inline-block'}),
        html.Div([
            html.Div(id='stripplot-container', style={'height': '400px'}),
            html.Div(id='histogram-container', style={'height': '400px'}),
            dcc.Graph(id='jobs-over-time', style={'width': '100%', 'height': '400px'})
        ], style={'width': '50%', 'display': 'inline-block'})
    ])
])
...
@app.callback(
    [Output('jobs-by-month', 'figure'), Output('career-level-pie', 'figure'), Output('stripplot-container', 'children'),
     Output('histogram-container', 'children'), Output('jobs-over-time', 'figure')],
...
def update_graph(selected_year):
    ...
    stripplot_container = html.Img(src='data:image/png;base64,{}'.format(stripplot_image))
    ...
    histogram_container = html.Img(src='data:image/png;base64,{}'.format(hist_image))
    ...
    return bar_figure, pie_figure, stripplot_container, histogram_container, line_figure
